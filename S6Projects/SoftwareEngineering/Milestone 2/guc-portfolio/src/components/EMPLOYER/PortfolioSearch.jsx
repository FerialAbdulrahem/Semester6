  ...
  return (
    <div className="sp">
      <div className="sp__page">
        <h1 className="cm__heading" style={{ background: 'linear-gradient(135deg, #60a5fa 0%, #a78bfa 60%, #f472b6 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Student Portfolios</h1>
